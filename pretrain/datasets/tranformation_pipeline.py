from monai.transforms import (Compose, CropForegroundd, Orientationd, RandShiftIntensityd,
                              ...
                              RandCropByPosNegLabeld, SaveImaged, SelectItemsd, EnsureChannelFirstd)

from pretrain.datasets.transforms import (CategoricalToOneHot, MapLabels, LRDivision, RandZoomd_select, MatchTemplate,
                                          GetAnnotationMask)
from utils.templates import NUM_CLASSES


def make_preprocessing_transforms(args):
    return Compose([
